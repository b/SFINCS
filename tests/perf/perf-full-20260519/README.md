# Perf sweep perf-full-20260519

Captured by `tests/perf/run_full_perf_matrix.sh` on 2026-05-20T01:04:40Z.
...
```
cd /home/b/development/github/Deltares/SFINCS/.sorcerer/worktrees/SOR-1025/b-SFINCS
python3 -m tests.perf.analyze.plot --sweep tests/perf/perf-full-20260519
```
...
```
SWEEP_DIR=tests/perf/perf-full-20260519 python3 -m jupyter lab tests/perf/analyze/explore.ipynb
```
