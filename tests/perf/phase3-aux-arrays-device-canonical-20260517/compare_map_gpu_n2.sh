#!/bin/bash
# SOR-67 Phase 3 — deterministic full-completion gpu_n2 run of
...
#
#     tests/perf/phase3-aux-arrays-device-canonical-20260517/compare_map_gpu_n2.sh pre
#     tests/perf/phase3-aux-arrays-device-canonical-20260517/compare_map_gpu_n2.sh post
#     cmp tests/perf/phase3-aux-arrays-device-canonical-20260517/sfincs_map.pre.nc \
#         tests/perf/phase3-aux-arrays-device-canonical-20260517/sfincs_map.post.nc
...
echo "=== SOR-67 Phase 3 map run: label=$LABEL ($CASE_NAME gpu_n2) ==="
( cd "$RUN_DIR"
